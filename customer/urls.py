...
urlpatterns =[
    path('product/<int:pk>', (cache_page(60*2))(views.ProductDetailView.as_view()), name = 'product'),
    ...
    path('product/review_add/<int:pk>/', (cache_page(60*2))(views.PermCreateReviewView.as_view()), name = 'add_review_perm'),
    path('review/delete/<int:pk>/', (cache_page(60*2))(views.DeleteReviewView.as_view()), name = 'delete_review'),
    path('basket/item/quantity_action/<int:pk>', views.ActionProductQuantityView.as_view(), name = 'action_quantity'),
    path('basket/item/delete/<int:pk>/', (cache_page(60*2))(views.DeleteItemBusketView.as_view()), name='delete_item_basket'),
